...
//  GPIO_LED.GPIO_Speed = GPIO_Speed_50MHz;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //GPIO_WriteBit(GPIOD, Red_LED_Pin);
//
...
//	    printf(temp);
	    ...
	    if (temp > 10) {
	      ...
	      //HAL_Delay(4000); // Wait for 300000 millisecond(s)
	    }printf("Warning");


//	  blueButton = HAL_GPIO_ReadPin(B1_button_GPIO_Port, B1_button_Pin);
//
//	  if (blueButton == 0) {
//
